  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <View style={styles.header}>
          <View style={{ flex: 1 }}>
            <Text style={styles.namaste}>
              Namaste, <Text style={styles.namasteName}>{firstName}</Text>{" "}
        ...
        {/* Quick Studio */}
        <Text style={styles.sectionTitle}>Quick Studio</Text>
        <ScrollView
          horizontal
