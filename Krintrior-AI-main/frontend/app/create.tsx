    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.loading}>
          ...
          <Text style={styles.loadingSub}>This usually takes 30–60 seconds</Text>
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
              ...
              <View style={styles.preview}>
                {imageUri ? (
                  ...
                  <View style={styles.previewEmpty}>
                    ...
                    <Text style={styles.previewEmptyText}>Photo preview</Text>
                  </View>
                )}
              </View>

              <TouchableOpacity testID="take-photo-btn" style={styles.uploadRow} onPress={takePhoto}>
                <View style={[styles.uploadIcon, { backgroundColor: colors.pastelOrange }]}>
                  <Ionicons name="camera" size={22} color={colors.primary} />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={styles.uploadRowTitle}>Take Photo</Text>
                  <Text style={styles.uploadRowSub}>Capture the room with your camera</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color={colors.textSubtle} />
              </TouchableOpacity>

              <TouchableOpacity testID="upload-area" style={styles.uploadRow} onPress={pickFromGallery}>
                <View style={[styles.uploadIcon, { backgroundColor: colors.pastelMint }]}>
                  <Ionicons name="images" size={22} color="#2C8866" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={styles.uploadRowTitle}>Choose from Gallery</Text>
                  <Text style={styles.uploadRowSub}>Pick an existing photo</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color={colors.textSubtle} />
              </TouchableOpacity>
            </View>
          ...
          {step === 1 && (
            <View style={{ gap: 16 }}>
              <Text style={styles.title}>What room{"\n"}is this?</Text>
              <Text style={styles.sub}>
          ...
          {step === 2 && (
            <View style={{ gap: 16 }}>
              ...
              <Text style={styles.bigBudget}>{formatINR(budget)}</Text>
              ...
              <View style={styles.budgetGrid}>
                {BUDGET_PRESETS.map((b) => {
                  ...
                  return (
                    ...
                    >
                      <Text style={[styles.budgetText, active && { color: "#fff" }]}>
                        {b.label}
                      </Text>
                    </Pressable>
                  );
          ...
          {step === 3 && (
            <View style={{ gap: 16 }}>
              ...
              <Text style={styles.sub}>Sets the mood and warmth of your design.</Text>
                ...
                {PALETTES.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text style={[styles.paletteLabel, active && { color: colors.primary }]}>
                        {p.id}
                      </Text>
                    </Pressable>
                  );
          ...
          {step === 4 && (
            <View style={{ gap: 16 }}>
              ...
              <Text style={styles.sub}>What do you envision? (optional)</Text>
              <TextInput
              ...
              <View style={styles.summaryCard}>
                ...
                <SummaryRow k="Room" v={roomType} />
                <SummaryRow k="Budget" v={formatINR(budget)} />
                <SummaryRow k="Palette" v={palette} />
              </View>
            </View>
          )}
        </ScrollView>
